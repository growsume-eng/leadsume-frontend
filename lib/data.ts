...
export const mockCampaigns: Campaign[] = [
  {
    ...
    sequences: [
      {
        id: "s1",
        subject: "Quick question about {your startup|your company}",
  ...
  },
  {
    ...
    sequences: [
      {
        id: "s4",
        subject: "Boost your {email|outreach} ROI",
  ...
  },
  {
    ...
    sequences: [
      {
        id: "s5",
        subject: "Partnership opportunity for {Agency|your team}",
  ...
  },
  {
    ...
    sequences: [
      {
        id: "s7",
        subject: "Seed round — {AI email|outreach automation} startup",
...
export const mockLeads: Lead[] = [
  { id: "l1", name: "Jordan Williams", email: "jordan@acmecorp.io", company: "Acme Corp", title: "CEO", status: "Contacted", tags: ["saas", "b2b"], owner: "Alex", createdAt: "2026-03-20T10:00:00Z" },
  { id: "l2", name: "Morgan Lee", email: "morgan@nexustech.com", company: "Nexus Tech", title: "CTO", status: "Qualified", tags: ["tech", "startup"], owner: "Alex", createdAt: "2026-03-21T10:00:00Z" },
  { id: "l3", name: "Taylor Brooks", email: "taylor@prismhq.co", company: "Prism HQ", title: "VP Sales", status: "New", tags: ["saas"], owner: "Sarah", createdAt: "2026-03-22T10:00:00Z" },
  { id: "l4", name: "Casey Morgan", email: "casey@sparkflow.io", company: "SparkFlow", title: "Founder", status: "Proposal", tags: ["b2b", "startup"], owner: "Alex", createdAt: "2026-03-23T10:00:00Z" },
  { id: "l5", name: "Riley Jordan", email: "riley@zenithsaas.com", company: "Zenith SaaS", title: "Head of Growth", status: "Won", tags: ["saas", "growth"], owner: "Sarah", createdAt: "2026-03-24T10:00:00Z" },
  { id: "l6", name: "Drew Nguyen", email: "drew@shopwave.io", company: "ShopWave", title: "CMO", status: "New", tags: ["ecommerce"], owner: "Sarah", createdAt: "2026-04-01T10:00:00Z" },
  { id: "l7", name: "Sam Patel", email: "sam@brandboost.co", company: "BrandBoost", title: "Founder", status: "Contacted", tags: ["ecommerce", "d2c"], owner: "Sarah", createdAt: "2026-04-02T10:00:00Z" },
  { id: "l8", name: "Quinn Davis", email: "quinn@reachretail.com", company: "Reach Retail", title: "CEO", status: "New", tags: ["ecommerce"], owner: "Alex", createdAt: "2026-04-03T10:00:00Z" },
  { id: "l9", name: "Avery Kim", email: "avery@pixelage.agency", company: "Pixel Age", title: "MD", status: "Qualified", tags: ["agency"], owner: "Alex", createdAt: "2026-03-10T10:00:00Z" },
  { id: "l10", name: "Blake Turner", email: "blake@fusionmktg.com", company: "Fusion Mktg", title: "CEO", status: "Lost", tags: ["agency"], owner: "Sarah", createdAt: "2026-03-11T10:00:00Z" },
  { id: "l11", name: "Parker Singh", email: "parker@vcventures.vc", company: "VC Ventures", title: "Partner", status: "Contacted", tags: ["investor"], owner: "Alex", createdAt: "2026-01-15T10:00:00Z" },
  { id: "l12", name: "Reese Chen", email: "reese@angelcap.io", company: "Angel Capital", title: "Managing Director", status: "Won", tags: ["investor"], owner: "Alex", createdAt: "2026-01-16T10:00:00Z" },
  { id: "l13", name: "Kai Johnson", email: "kai@devhive.tech", company: "DevHive", title: "CTO", status: "New", tags: ["tech"], owner: "Sarah", createdAt: "2026-04-15T10:00:00Z" },
  { id: "l14", name: "Skylar Ross", email: "skylar@cloudbase.io", company: "CloudBase", title: "VP Eng", status: "New", tags: ["saas", "tech"], owner: "Alex", createdAt: "2026-04-16T10:00:00Z" },
  { id: "l15", name: "Emery Walsh", email: "emery@launchpad.co", company: "LaunchPad", title: "COO", status: "Contacted", tags: ["startup"], owner: "Sarah", createdAt: "2026-04-17T10:00:00Z" },
  { id: "l16", name: "Rowan Bell", email: "rowan@scaledge.io", company: "ScalEdge", title: "Head of Ops", status: "Qualified", tags: ["b2b"], owner: "Alex", createdAt: "2026-04-18T10:00:00Z" },
  { id: "l17", name: "Finley Cooper", email: "finley@marketwise.com", company: "MarketWise", title: "CMO", status: "Proposal", tags: ["marketing"], owner: "Sarah", createdAt: "2026-04-19T10:00:00Z" },
  { id: "l18", name: "Hayden Mills", email: "hayden@growfast.io", company: "GrowFast", title: "CEO", status: "Won", tags: ["saas", "growth"], owner: "Alex", createdAt: "2026-04-20T10:00:00Z" },
  { id: "l19", name: "Lennox Gray", email: "lennox@datapulse.co", company: "DataPulse", title: "Data Lead", status: "New", tags: ["data", "saas"], owner: "Sarah", createdAt: "2026-04-21T10:00:00Z" },
  { id: "l20", name: "Noel Rivera", email: "noel@outreachly.com", company: "Outreachly", title: "Founder", status: "Lost", tags: ["saas"], owner: "Alex", createdAt: "2026-04-22T10:00:00Z" },
];
